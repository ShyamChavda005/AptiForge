                ...
                <div className="mx-auto max-w-3xl">
                    ...
                    <div className="mt-12 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                        ...
                        <div className="flex items-center justify-between mt-7 mx-5">
                            <button onClick={() => window.location.reload()} className="cursor-pointer rounded-lg border border-indigo-200 bg-indigo-50 px-5 py-2 text-sm font-medium text-indigo-700 transition hover:border-indigo-300 hover:bg-indigo-100">
                                ↻ Refresh
                            </button>
